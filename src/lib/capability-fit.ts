...
const OPTIONAL_CAPABILITY_HEADROOM = 0.10
 ...
 * add a deliberately small amount of value, but unrelated capabilities (for
 * example audio on a text-only task) never improve the score.
 */
