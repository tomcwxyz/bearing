    ...
    const candidates = [
      {
        ...
        estCost: 0,
        estCo2g: null,
        executionProvider: (formData.get('primaryExecutionProvider') as string | null) ?? undefined,
        executionRoute: (formData.get('primaryExecutionRoute') as string | null) ?? undefined,
        runtimeModelId: (formData.get('primaryRuntimeModelId') as string | null) ?? undefined,
